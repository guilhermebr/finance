...
// AccountRepositoryMock is a mock implementation of finance.AccountRepository.
//
//	func TestSomethingThatUsesAccountRepository(t *testing.T) {
//
//		// make and configure a mocked finance.AccountRepository
...
//		}
//
//		// use mockedAccountRepository in code that requires finance.AccountRepository
...
func (mock *AccountRepositoryMock) CreateAccount(ctx context.Context, account entities.Account) (entities.Account, error) {
	callInfo := struct {
		Ctx     context.Context
		Account entities.Account
	}{
...
func (mock *AccountRepositoryMock) DeleteAccount(ctx context.Context, id string) error {
	callInfo := struct {
		Ctx context.Context
		ID  string
	}{
...
// Check the length with:
//
//	len(mockedAccountRepository.DeleteAccountCalls())
func (mock *AccountRepositoryMock) DeleteAccountCalls() []struct {
	Ctx context.Context
	ID  string
} {
	var calls []struct {
...
func (mock *AccountRepositoryMock) GetAccountByID(ctx context.Context, id string) (entities.Account, error) {
	callInfo := struct {
		Ctx context.Context
		ID  string
	}{
...
func (mock *AccountRepositoryMock) GetAllAccounts(ctx context.Context) ([]entities.Account, error) {
	callInfo := struct {
		Ctx context.Context
	}{
		Ctx: ctx,
...
func (mock *AccountRepositoryMock) UpdateAccount(ctx context.Context, account entities.Account) (entities.Account, error) {
	callInfo := struct {
		Ctx     context.Context
		Account entities.Account
	}{
